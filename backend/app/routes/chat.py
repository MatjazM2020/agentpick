...
Request logging happens inside the agent runners (``src.agent.request_scope``).
"""
...
async def chat_completions(request: ChatCompletionRequest):
    ...
    return openai_io.completion_response(text, completion_id, request.model, created)
